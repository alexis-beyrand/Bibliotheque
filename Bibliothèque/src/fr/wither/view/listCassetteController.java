...
public class listCassetteController {
	@FXML
	private TableView<Cassettes> table;
	@FXML
	private TableColumn<Cassettes, String> col_titre;
	@FXML
	private Button btn_back;
	
	@FXML
	public void initialize() {
		ObservableList<Cassettes> list = FXCollections.observableArrayList();
		col_titre.setCellValueFactory(new PropertyValueFactory<>("titre"));
		SQLCommon.fillCassettesList(Main.conn, list);
		table.setItems(list);
	}
